...
call s:HL('CursorColumn', '', 'deepergravel')
...
call s:HL('Visual',    '',  'lightgravel')
call s:HL('VisualNOS', '',  'lightgravel')
...
call s:HL('LineNr',     'lightgravel', s:gutter)
call s:HL('SignColumn', '',             s:gutter)
call s:HL('FoldColumn', 'lightgravel', s:gutter)
...
call s:HL('DiffDelete', 'taffy', 'taffy')
call s:HL('DiffAdd',    '',     'lime')
call s:HL('DiffChange', '',     'orange')
call s:HL('DiffText',   'snow', 'deepergravel', 'bold')
...
" Punctuation
call s:HL('htmlTag',    'lime', 'bg', 'none')
call s:HL('htmlEndTag', 'lime', 'bg', 'none')

" Tag names
call s:HL('htmlTagName',        'lime', '', 'bold')
call s:HL('htmlSpecialTagName', 'lime', '', 'bold')
call s:HL('htmlSpecialChar',    'dress',   '', 'none')

call s:HL('htmlString',    'taffy',   '', 'none')
